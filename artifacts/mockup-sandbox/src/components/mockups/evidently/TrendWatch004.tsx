// TrendWatch004 — Issue 004 archive: Mandelic acid is having a moment.
...
const VERDICTS = [
  { n: "01", name: "Mandelic 10% serums", tier: "A" as const, verdict: "Holds Up", color: T.tierA,
    body: "Mandelic acid's larger molecular weight (152 Da, vs glycolic's 76) means slower, gentler stratum-corneum penetration — historically dismissed as 'less effective' by AHA enthusiasts, now re-evaluated as exactly the property that makes it the better choice for skin of colour, sensitive types, and acne-prone surfaces. Three new Indian RCTs through 2025 have shown 10% mandelic at pH 3.4–3.6 producing comparable comedonal-acne and PIH endpoints to glycolic at lower irritation rates.",
    bottom: "The default AHA for melanin-rich and reactive skin. Tier A on its own merits, not by deference." },
  { n: "02", name: "Mandelic + lactic blends", tier: "B" as const, verdict: "Partly True", color: T.tierB,
    body: "Combination AHA serums (mandelic + lactic, often + a small percentage of salicylic) chase a 'wider exfoliation envelope' that the literature only partially supports. The blend formulations are typically pH-managed reasonably well, but the additive endpoints often plateau at what 10% mandelic alone delivers. Not bad — the best of these are very tolerable — but rarely meaningfully different from a clean single-acid serum.",
    bottom: "Tolerable, marginally additive. Pay for the formulation only if texture differs meaningfully." },
];

const TrendWatch004: React.FC = () => (
  <div className="relative" style={{ background: T.paper, color: T.ink, fontFamily: SANS }}>
    <LaidPaper />
    <SiteHeader active="Trend Watch" />
    <Breadcrumbs trail={[{ label: "Home", href: "#" }, { label: "Trend Watch", href: "#" }, { label: "Issue 004 · Archive" }]} />
        ...
        <div className="relative grid grid-cols-12 gap-10 py-24">
          <div className="col-span-12 lg:col-span-9 lg:pl-12">
            <div className="flex items-center justify-between border-b pb-4" style={{ borderColor: T.rule }}>
              <Eyebrow color={T.accent}>Trend Watch · Issue 004 · 01 December 2025</Eyebrow>
            ...
            <div className="mt-10 inline-flex items-center gap-3 px-4 py-2 border" style={{ borderColor: T.rule, background: T.paper2 }}>
              <span style={{ fontFamily: MONO, fontSize: 11, letterSpacing: "0.18em", color: T.muted, textTransform: "uppercase" }}>Issue № 004 · Archive</span>
            </div>
            <h1 className="mt-6" style={{ fontFamily: SERIF, fontSize: 110, lineHeight: 0.92, letterSpacing: "-0.045em", fontWeight: 400, color: T.ink, fontVariationSettings: '"opsz" 144, "SOFT" 30' }}>
              Mandelic, with <br />
              <span style={{ fontStyle: "italic", color: T.accent, fontFamily: SERIF_ED }}>footnotes.</span>
            </h1>
            <p className="mt-9 max-w-2xl" style={{ fontFamily: SERIF, fontSize: 21, lineHeight: 1.55, color: T.inkSoft }}>
              The case for mandelic in skin of colour is stronger than the case for glycolic. We agree with the moment — and we add the boring qualifications no one is making on social.
            </p>
          </div>
        </div>
      </Container>
    ...
    <TrendWatchRelated component="TrendWatch004" />

    <SiteFooter />
  </div>
);

export default TrendWatch004;
